...
MODULE_OFFDIAG(Q_Gaussian,EVB_OffDiag_Q_Gaussian)

#else


#ifndef EVB_OFFDIAGONAL_Q_GAUSSIAN
#define EVB_OFFDIAGONAL_Q_GAUSSIAN
...
class EVB_OffDiag_Q_Gaussian : public EVB_OffDiag
{
 public:
  EVB_OffDiag_Q_Gaussian(class LAMMPS *, class EVB_Engine*);
  virtual ~EVB_OffDiag_Q_Gaussian();
