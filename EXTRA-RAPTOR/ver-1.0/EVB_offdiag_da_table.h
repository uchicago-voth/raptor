...
MODULE_OFFDIAG(DA_Table,EVB_OffDiag_DA_Table)

#else


#ifndef EVB_OFFDIAGONAL_DA_TABLE
#define EVB_OFFDIAGONAL_DA_TABLE
...
class EVB_OffDiag_DA_Table : public EVB_OffDiag
{
public:
  EVB_OffDiag_DA_Table(class LAMMPS *, class EVB_Engine*);
  virtual ~EVB_OffDiag_DA_Table();
