...
MODULE_OFFDIAG(PT_FR_Table,EVB_OffDiag_PT_FR_Table)

#else


#ifndef EVB_OFFDIAGONAL_PT_FR_TABLE
#define EVB_OFFDIAGONAL_PT_FR_TABLE
...
class EVB_OffDiag_PT_FR_Table : public EVB_OffDiag
{
public:
  EVB_OffDiag_PT_FR_Table(class LAMMPS *, class EVB_Engine*);
  virtual ~EVB_OffDiag_PT_FR_Table();
