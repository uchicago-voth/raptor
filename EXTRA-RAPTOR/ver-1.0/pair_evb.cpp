...
PairEVB::PairEVB(LAMMPS *lmp) : Pair(lmp)
{
  respa_enable = 1;
  ftable = NULL;
...
void PairEVB::compute(int eflag, int vflag)
{
  switch(flag)
  {
    case 0: compute_lj_erfc(eflag, vflag); break;
    case 1: compute_lj_coul(eflag, vflag); break;
    
    case 2: compute_lj(eflag, vflag); break;
    case 3: compute_lj_ecoul(eflag, vflag); break;
    case 4: compute_erfc(eflag,vflag); break;
  }
}

/* ---------------------------------------------------------------------- */

void PairEVB::compute_erfc(int eflag, int vflag)
{
...
void PairEVB::compute_lj(int eflag, int vflag)
{
  int i,ii,j,jj,inum,jnum,itype,jtype,itable;
  double qtmp,xtmp,ytmp,ztmp,delx,dely,delz,evdwl,ecoul,fpair;
  double fraction,table;
...
void PairEVB::compute_lj_ecoul(int eflag, int vflag)
{
  int i,ii,j,jj,inum,jnum,itype,jtype,itable;
  double qtmp,xtmp,ytmp,ztmp,delx,dely,delz,evdwl,ecoul,fpair;
  double fraction,table;
...
void PairEVB::compute_lj_coul(int eflag, int vflag)
{
  int i,ii,j,jj,inum,jnum,itype,jtype,itable;
  double qtmp,xtmp,ytmp,ztmp,delx,dely,delz,evdwl,ecoul,fpair;
  double fraction,table;
...
void PairEVB::compute_lj_erfc(int eflag, int vflag)
{
  int i,ii,j,jj,inum,jnum,itype,jtype,itable;
  double qtmp,xtmp,ytmp,ztmp,delx,dely,delz,evdwl,ecoul,fpair;
  double fraction,table;
...
void PairEVB::compute_outer(int eflag, int vflag)
{
...
void PairEVB::settings(int narg, char **arg)
{
...
void PairEVB::coeff(int narg, char **arg)
{
...
void PairEVB::init_list(int id, NeighList *ptr)
{
  if (id == 0) list = ptr;
...
double PairEVB::init_one(int i, int j)
{
  if (setflag[i][j] == 0) {
...
void PairEVB::write_restart(FILE *fp)
{
...
void PairEVB::read_restart(FILE *fp)
{
...
void PairEVB::write_restart_settings(FILE *fp)
{
...
void PairEVB::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairEVB::single(int i, int j, int itype, int jtype,
				 double rsq,
...
void *PairEVB::extract(char *str, int &dim)
{
  dim = 0;
