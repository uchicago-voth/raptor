...
MODULE_REPULSIVE(Hydroxide_FR_Table,EVB_Rep_Hydroxide_FR_Table)

#else

#ifndef EVB_REP_HYDROXIDE_FR_TABLE_H
#define EVB_REP_HYDROXIDE_FR_TABLE_H
...
class EVB_Rep_Hydroxide_FR_Table : public EVB_Repulsive
{
 public:
  EVB_Rep_Hydroxide_FR_Table(class LAMMPS *, class EVB_Engine*);
  virtual ~EVB_Rep_Hydroxide_FR_Table();
 ...
 private:
  ...
  int flag_SW;
  double epsilon_SW, cut_SW, T0_SW; 
};
